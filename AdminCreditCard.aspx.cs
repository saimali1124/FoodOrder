...
public partial class AdminCreditCard : System.Web.UI.Page
{
    ...
    {
        string query = "execute insertCreditCard @userid= '" + TextBox1.Text + "' , @pin = '" + TextBox2.Text + "' , @balance = '" + TextBox4.Text + "'";
        ...
        {
            Label7.Text = "Wrong Information. Data not inserted.";
        }
